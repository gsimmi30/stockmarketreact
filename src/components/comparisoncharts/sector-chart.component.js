...
export default class SectorChart extends Component {
    constructor(props) {
        ...
        this.onChangeSectoName = this.onChangeSectoName.bind(this);
              ...
              <form>
                ...
                <div className="form-group">
                  ...
                  <input
                    ...
                    onChange={this.onChangeSectoName}
                    required></input>
